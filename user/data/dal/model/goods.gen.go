...
// Good 商品表
type Good struct {
	ID         uint32    `gorm:"column:id;type:bigint;primaryKey;autoIncrement:true" json:"id"`
	...
	Price      float32   `gorm:"column:price;type:float;not null;comment:价格" json:"price"`                                            // 价格
