...
type GoodsGetPageReq struct {
	...
	PageSize  uint32          `json:"page_size" form:"page_size" binding:"required"`
	PageNum   uint32          `json:"page_num" form:"page_num" binding:"required"`
}
...
type GoodsCreateReq struct {
	GoodsType *string         `json:"goods_type" form:"goods_type" binding:"required" `  // 商品编号
